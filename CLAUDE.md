...
This project is indexed by GitNexus as **hivespace.microservice** (7137 symbols, 17928 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
