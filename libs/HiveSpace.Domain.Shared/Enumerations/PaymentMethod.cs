...
{
    public static readonly PaymentMethod COD = new(1, nameof(COD));
    public static readonly PaymentMethod VNPAY = new(2, nameof(VNPAY));
    ...
    public static readonly PaymentMethod PayPal = new(6, nameof(PayPal));
