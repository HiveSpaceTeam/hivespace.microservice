...
public static class MobileTabletSeedData
{
    ...
    public static async Task SeedAsync(CatalogDbContext context, CancellationToken cancellationToken = default)
    {
        ...
        var products = new List<Product>
        {
            ...
            BuildSamsungA265G(now, attrMap),
            BuildCuSacSamsung25W(now, attrMap),
            BuildTabA11(now, attrMap),
            BuildSamsungA375G(now, attrMap),
            BuildSamsungA165G(now, attrMap),
            BuildIPhone17e(now, attrMap),
            BuildSamsungS26Ultra(now, attrMap),
            BuildSamsungS26(now, attrMap),
        };
    ...
    private static Product BuildSamsungA265G(DateTimeOffset now, Dictionary<string, int> attrMap)
    {
        var images = new List<ProductImage>
        {
        ...
        var skuXanh = new Sku("4276090513087",
            ...
            quantity: 100, isActive: true, price: new Money(6990000m, Currency.VND));
        ...
        return BuildFull("Điện thoại Samsung Galaxy A26 5G (8/128GB), Mặt lưng kính, AI-Circle to Search, Camera HDR chụp đêm sáng rõ - Hàng chính hãng",
            ...
            images, attributes, [skuXanh, skuDen, skuCam], variants, description, now);
    }

    // ── Product 3: Củ Sạc Samsung 25W ────────────────────────────────────────────
    private static Product BuildCuSacSamsung25W(DateTimeOffset now, Dictionary<string, int> attrMap)
    {
        var images = new List<ProductImage>
        {
        ...
        var skuTrang = new Sku("7768310632659",
            ...
            quantity: 100, isActive: true, price: new Money(540000m, Currency.VND));
        ...
        return BuildFull("Củ Sạc Samsung Không Kèm Cáp 25W - Hàng Chính Hãng",
            ...
            images, attributes, [skuTrang], variants, description, now);
    }

    // ── Product 4: Samsung Galaxy Tab A11 WiFi ───────────────────────────────────
    private static Product BuildTabA11(DateTimeOffset now, Dictionary<string, int> attrMap)
    {
        var images = new List<ProductImage>
        {
        ...
        var skuBac = new Sku("1517847354506",
            ...
            quantity: 100, isActive: true, price: new Money(3990000m, Currency.VND));
        ...
        return BuildFull("Máy Tính Bảng Samsung Galaxy Tab A11 WiFi 4GB/64GB - Đã Kích Hoạt Bảo Hành Điện Tử - Hàng Chính Hãng",
            ...
            images, attributes, [skuBac], variants, description, now);
    }

    // ── Product 5: Samsung Galaxy A37 5G ─────────────────────────────────────────
    private static Product BuildSamsungA375G(DateTimeOffset now, Dictionary<string, int> attrMap)
    {
        var images = new List<ProductImage>
        {
        ...
        var skuXanh = new Sku("1807041004396",
            ...
            quantity: 100, isActive: true, price: new Money(10990000m, Currency.VND));
        ...
        return BuildFull("Điện Thoại Samsung Galaxy A37 5G (8GB/128GB) - Hàng Chính Hãng",
            ...
            images, attributes, [skuXanh, skuDen, skuTrang, skuTim], variants, description, now);
    }

    // ── Product 6: Samsung Galaxy A16 5G ─────────────────────────────────────────
    private static Product BuildSamsungA165G(DateTimeOffset now, Dictionary<string, int> attrMap)
    {
        var images = new List<ProductImage>
        {
        ...
        var skuDen = new Sku("9356381205803",
            ...
            quantity: 100, isActive: true, price: new Money(4990000m, Currency.VND));
        ...
        return BuildFull("Điện Thoại Samsung Galaxy A16 5G (4GB/128GB) - Đã Kích Hoạt Bảo Hành Điện Tử - Hàng Chính Hãng",
            ...
            images, attributes, [skuDen], variants, description, now);
    }

    // ── Product 7: Apple iPhone 17e ──────────────────────────────────────────────
    private static Product BuildIPhone17e(DateTimeOffset now, Dictionary<string, int> attrMap)
    {
        var images = new List<ProductImage>
        {
        ...
        var skuTrang = new Sku("8390602435727",
            ...
            quantity: 100, isActive: true, price: new Money(16990000m, Currency.VND));
        ...
        return BuildFull("Apple iPhone 17e",
            ...
            images, attributes, [skuTrang, skuDen, skuHong], variants, description, now);
    }
        ...
        string description, DateTimeOffset now)
    {
        ...
        var product = new Product(
            ...
            categories: categories, attributes: attributes, images: images,
            skus: skus, variants: variants,
            createdAt: now, updatedAt: null, createdBy: "seed", updatedBy: null
        );
    ...
    private static Product BuildSamsungS26Ultra(DateTimeOffset now, Dictionary<string, int> attrMap)
    {
        var images = new List<ProductImage>
        {
        ...
        var skuTrang = new Sku("5133113695023",
            ...
            quantity: 100, isActive: true, price: new Money(36990000m, Currency.VND));
            
        var skuDen = new Sku("8308809436012",
            [new SkuVariant("Màu sắc", "Đen")],
            [new SkuImage("https://salt.tikicdn.com/cache/280x280/ts/product/43/51/c7/cb1cb2583bc8c5d5ea0c9ed4a1f0394f.jpg")],
            quantity: 100, isActive: true, price: new Money(36990000m, Currency.VND));
            
        var skuTim = new Sku("2102639080540",
            [new SkuVariant("Màu sắc", "Tím")],
            [new SkuImage("https://salt.tikicdn.com/cache/280x280/ts/product/43/51/c7/3561261ed1e13d4fe0daf97d5e2483e7.jpg")],
            quantity: 100, isActive: true, price: new Money(36990000m, Currency.VND));

        const string description = """
            <p><strong>Samsung Galaxy S26 Ultra</strong></p>
            <p>Trải nghiệm đỉnh cao của Samsung Galaxy với Galaxy AI tiên tiến. Viền Titanium mạnh mẽ, kính cường lực Gorilla Armor chống phản chiếu cực tốt.</p>
            <p>Màn hình Dynamic AMOLED 2X 6.9 inch 120Hz siêu sáng, sắc nét tới từng chi tiết. Chip Snapdragon 8 Elite hiệu năng cực đỉnh, tối ưu cho AI và Gaming.</p>
            <p>Camera chính 200MP bắt trọn chi tiết, camera tele zoom quang học 10x mang thế giới tới gần bạn. Tính năng ProVisual tối ưu chất lượng ảnh trong mọi điều kiện ánh sáng.</p>
            <p>S Pen tích hợp cho phép bạn viết, vẽ và tương tác với thiết bị một cách hoàn toàn mới.</p>
            <p><img src="https://salt.tikicdn.com/ts/tmp/55/b5/d3/63fd1d5f724e7da7bb59290c655f8a8f.jpg" alt="" width="750" height="375" /></p>
            <p><img src="https://salt.tikicdn.com/ts/tmp/d4/cf/8b/a5907dcae572661101f0ffa9c76fa586.jpg" alt="" width="750" height="418" /></p>
            <p><img src="https://salt.tikicdn.com/ts/tmp/1c/eb/83/f38898ab9e85a519a60c92d0a6246832.jpg" alt="" width="750" height="375" /></p>
            <p><img src="https://salt.tikicdn.com/ts/tmp/a4/a9/78/6c0f359ef09d5a8e2d1fae818f87fd87.jpg" alt="" width="750" height="375" /></p>
            <p><img src="https://salt.tikicdn.com/ts/tmp/cc/c0/0e/3c51e0bed55adb04532f2c8f3443f28e.jpg" alt="" width="750" height="375" /></p>
            <p><img src="https://salt.tikicdn.com/ts/tmp/8c/d1/cf/2229e7bbadd248f837851fbc877e789d.jpg" alt="" width="750" height="375" /></p>
            <p><img src="https://salt.tikicdn.com/ts/tmp/33/be/b9/31672b756552c6899f5ae6edf278ff75.jpg" alt="" width="750" height="375" /></p>
            """;
        ...
        return BuildFull("Điện Thoại Samsung Galaxy S26 Ultra (12GB/256GB) - Hàng Chính Hãng",
            ...
            images, attributes, [skuTrang, skuDen, skuTim], variants, description, now);
    }

    // ── Product 9: Samsung Galaxy S26 ────────────────────────────────────────────
    private static Product BuildSamsungS26(DateTimeOffset now, Dictionary<string, int> attrMap)
    {
        var images = new List<ProductImage>
        {
            new(0, "https://salt.tikicdn.com/cache/w1200/ts/product/8e/49/54/7cb00769381d688d3540d20c85688c7d.jpg"),
            new(0, "https://salt.tikicdn.com/cache/w1200/ts/product/8e/00/5f/209ea7b56c8108cb39257daaa765d48b.jpg")
        };

        var attributes = BuildMobileAttrs(attrMap,
            thuongHieu: "Samsung", xuatXu: "Việt Nam", dungLuongPin: "4000 mAh",
            manHinh: "Dynamic AMOLED 2X", cameraSau: "50 MP + 10 MP + 12 MP", cameraTruoc: "12 MP",
            cpu: "Snapdragon 8 Elite");

        var variantMau = new ProductVariant("Màu sắc");
        variantMau.AddOption("Trắng"); variantMau.AddOption("Tím"); variantMau.AddOption("Xanh"); variantMau.AddOption("Đen");
        var variants = new List<ProductVariant> { variantMau };

        var skuTrang = new Sku("2565010916174",
            [new SkuVariant("Màu sắc", "Trắng")],
            [new SkuImage("https://salt.tikicdn.com/cache/280x280/ts/product/8e/49/54/7cb00769381d688d3540d20c85688c7d.jpg")],
            quantity: 100, isActive: true, price: new Money(25990000m, Currency.VND));
            
        var skuTim = new Sku("7727270065680",
            [new SkuVariant("Màu sắc", "Tím")],
            [new SkuImage("https://salt.tikicdn.com/cache/280x280/ts/product/8e/49/54/08c6ab66027620ef231fe7142c578536.jpg")],
            quantity: 100, isActive: true, price: new Money(25990000m, Currency.VND));
        ...
        return BuildFull("Điện Thoại Samsung Galaxy S26 (12GB/256GB) - Hàng Chính Hãng",
            ...
            images, attributes, [skuTrang, skuTim, skuXanh, skuDen], variants, description, now);
    }
}
