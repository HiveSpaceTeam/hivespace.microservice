...
public class OrderStatus(int id, string name) : Enumeration(id, name)
{
    ...
    public static readonly OrderStatus ReadyToShip = new(15, nameof(ReadyToShip));
    ...
    public bool CanBeConfirmed()  => this == Paid || this == COD;
    public bool CanBeRejected()   => this == Paid || this == COD;
    public bool CanBeShipped()    => this == Confirmed || this == ReadyToShip;
