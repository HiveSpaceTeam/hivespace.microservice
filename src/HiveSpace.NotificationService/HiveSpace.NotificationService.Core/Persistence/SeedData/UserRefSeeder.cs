    ...
    ILogger<UserRefSeeder>      logger) : ISeeder
{
    ...
    private static readonly (Guid UserId, string Email, string FullName, Culture Locale, string? UserName, string? AvatarUrl, Guid? StoreId, string? StoreName, string? StoreLogoUrl)[] Seeds =
    [
        (new Guid("a1b2c3d4-e5f6-7890-abcd-ef1234567890"), "dev5k@gmail.com",       "Tiki Trading",        Culture.Vi, "tiki",       null,
        ...
        (new Guid("c3d4e5f6-a7b8-9012-cdef-012345678901"), "giver@gmail.com",      "GIVER BOOKS & MEDIA", Culture.Vi, "giver",      null,
        ...
        (new Guid("d4e5f6a7-b8c9-0123-def0-123456789012"), "phuongdong@gmail.com", "Phương Đông Books",   Culture.Vi, "phuongdong", null,
        ...
        (new Guid("11111111-1111-1111-1111-111111111111"), "aliceSmith@gmail.com", "Alice Smith",         Culture.Vi, "alice",      "https://cdn.discordapp.com/avatars/474579515188707339/24acc2c6b645216504447360a58c0683.webp",
            null, null, null),
        (new Guid("22222222-2222-2222-2222-222222222222"), "dev5k@gmail.com",   "Bob Smith",           Culture.Vi, "bob",        "https://cdn.discordapp.com/avatars/743061397037908059/edaa33d7f618405017a26cc7ca42379b.webp",
            null, null, null),
    ];
