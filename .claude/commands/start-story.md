...
- State the story, affected service(s), and exact tasks from `tasks.md` for this session.
...
- Keep edits scoped to the selected story/task group.
...
- If more tasks remain, identify the next story/task group.
