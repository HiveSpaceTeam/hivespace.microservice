...
This project is indexed by GitNexus as **hivespace.microservice** (6960 symbols, 17816 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
