...
This project is indexed by GitNexus as **hivespace.microservice** (7030 symbols, 18026 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
